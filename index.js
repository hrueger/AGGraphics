...
function initialSetup() {
	...
	appSettings.post('/manage', function (req, res) {
		...
		let result = AGGraphics_Manage(obj);
		res.send(result);
	});
	...
	io.sockets.on('connection', function(socket) {
		...
		socket.on('manage', function(arbiterObj) {
			response = AGGraphics_Manage(arbiterObj);
...
function AGGraphics_Manage(obj) {
	switch(obj.type) {
		case 'source':
			if (obj.action === 'add') {
				result = AGGraphics_Add_Source(obj);
			}
			else if (obj.action === 'edit') {
				result = AGGraphics_Edit_Source(obj);
			}
			else if (obj.action === 'delete') {
				result = AGGraphics_Delete_Source(obj);
			}
			break;
		case 'device':
			if (obj.action === 'add') {
				result = AGGraphics_Add_Device(obj);
			}
			else if (obj.action === 'edit') {
				result = AGGraphics_Edit_Device(obj);
			}
			else if (obj.action === 'delete') {
				result = AGGraphics_Delete_Device(obj);
			}
			break;
		case 'device_source':
			if (obj.action === 'add') {
				result = AGGraphics_Add_Device_Source(obj);
			}
			else if (obj.action === 'edit') {
				result = AGGraphics_Edit_Device_Source(obj);
			}
			else if (obj.action === 'delete') {
				result = AGGraphics_Delete_Device_Source(obj);
			}
			break;
		case 'device_action':
			if (obj.action === 'add') {
				result = AGGraphics_Add_Device_Action(obj);
			}
			else if (obj.action === 'edit') {
				result = AGGraphics_Edit_Device_Action(obj);
			}
			else if (obj.action === 'delete') {
				result = AGGraphics_Delete_Device_Action(obj);
			}
			break;
		case 'tsl_client':
			if (obj.action === 'add') {
				result = AGGraphics_Add_TSL_Client(obj);
			}
			else if (obj.action === 'edit') {
				result = AGGraphics_Edit_TSL_Client(obj);
			}
			else if (obj.action === 'delete') {
				result = AGGraphics_Delete_TSL_Client(obj);
			}
			break;
		case 'cloud_destination':
			if (obj.action === 'add') {
				result = AGGraphics_Add_Cloud_Destination(obj);
			}
			else if (obj.action === 'edit') {
				result = AGGraphics_Edit_Cloud_Destination(obj);
			}
			else if (obj.action === 'delete') {
				result = AGGraphics_Delete_Cloud_Destination(obj);
			}
			break;
		case 'cloud_key':
			if (obj.action === 'add') {
				result = AGGraphics_Add_Cloud_Key(obj);
			}
			else if (obj.action === 'delete') {
				result = AGGraphics_Delete_Cloud_Key(obj);
			}
			break;
		case 'cloud_client':
			if (obj.action === 'remove') {
				result = AGGraphics_Remove_Cloud_Client(obj);
			}
			break;
		default:
...
function AGGraphics_Add_Source(obj) {
...
function AGGraphics_Edit_Source(obj) {
	let sourceObj = obj.source;
...
function AGGraphics_Delete_Source(obj) {
...
function AGGraphics_Add_Device(obj) {
...
function AGGraphics_Edit_Device(obj) {
	let deviceObj = obj.device;
	for (let i = 0; i < devices.length; i++) {
...
function AGGraphics_Delete_Device(obj) {
	let deviceId = obj.deviceId;
	let deviceName = GetDeviceByDeviceId(deviceId).name;
...
function AGGraphics_Add_Device_Source(obj) {
...
function AGGraphics_Edit_Device_Source(obj) {
	let deviceSourceObj = obj.device_source;
	let deviceId = null;
	let oldAddress = null;
	for (let i = 0; i < device_sources.length; i++) {
...
function AGGraphics_Delete_Device_Source(obj) {
...
function AGGraphics_Add_Device_Action(obj) {
...
function AGGraphics_Edit_Device_Action(obj) {
	let deviceActionObj = obj.device_action;
	let deviceId = null;
...
function AGGraphics_Delete_Device_Action(obj) {
...
function AGGraphics_Add_TSL_Client(obj) {
...
function AGGraphics_Edit_TSL_Client(obj) {
	let tslClientObj = obj.tslClient;
...
function AGGraphics_Delete_TSL_Client(obj) {
...
function AGGraphics_Add_Cloud_Destination(obj) {
...
function AGGraphics_Edit_Cloud_Destination(obj) {
	let cloudObj = obj.cloudDestination;
...
function AGGraphics_Delete_Cloud_Destination(obj) {
...
function AGGraphics_Add_Cloud_Key(obj) {
...
function AGGraphics_Delete_Cloud_Key(obj) {
...
function AGGraphics_Remove_Cloud_Client(obj) {
	let ipAddress = null;
	let key = null;
...
function getConfigFilePath() {
	const configFolder = path.join(process.env.APPDATA || (process.platform == 'darwin' ? process.env.HOME + '/Library/Preferences' : process.env.HOME + "/.local/share"), "AGGraphics");
